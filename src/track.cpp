...
Track::Track(const QString &track, const QString &title, const QString &comment,
             const QString &genre, const QString &artist, const QString &album,
             const QString &mrl, const QString &path, const QString &length,
             const QString &lengthString, const QString &year,
             const QString &dateAdded, const QString &id)
    : track_(track.toInt()),
      title_(title),
      comment_(comment),
      genre_(genre),
