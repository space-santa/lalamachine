...
MusicLib::MusicLib(QObject *parent) : QObject(parent) {
  ...
  connect(scanner_, &MusicLibScanner::scanStarted, this,
  ...
  connect(this, &MusicLib::titlePartialFilterChanged, this,
  ...
  connect(&watcher_, &QFutureWatcher<QSqlQuery>::finished, this,
