...
void TestAutoPlaylist::testToQuery() {
  ...
  AutoPlaylistObject apo1(LalaTypes::AND, LalaTypes::GENRE, LalaTypes::IS,
                          "Electro House");
  AutoPlaylistObject apo2(LalaTypes::OR, LalaTypes::ALBUM, LalaTypes::IS_NOT,
                          "stuff");
  AutoPlaylistObject apo3(LalaTypes::AND, LalaTypes::ARTIST,
                          LalaTypes::CONTAINS, "moo");
  list.addApo(apo1);
  list.addApo(apo2);
  list.addApo(apo3);
